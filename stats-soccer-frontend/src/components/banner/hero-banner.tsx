export default function HeroBanner(){
    return (
<div className="relative isolate overflow-hidden bg-[#0d1b0d] py-24 sm:py-32">
  <img
  ...
  <div className="absolute inset-0 -z-10 bg-black/70" /> {/* Overlay escuro para contraste */}

  {/* Decoração em background */}
  <div
